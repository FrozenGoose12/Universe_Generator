...
def Universe_Generator(Universe_Seed = random.randint(0, 10000), debug = 0):
    ...
    for nebula in range(Nebula_rng.randint(3, 6)):
        ...
        proportional = Nebula_rng.randint(100, 400)
        NebulaGenerator(
                (Nebula_rng.randint(0, screen.get_width()), Nebula_rng.randint(0, screen.get_height())), #center
    ...
    for galaxy in range(Galaxy_rng.randint(1, 5)):
        ...
        if giga_galaxy == 7:
            ...
            max_radius = Galaxy_rng.randint(30, 479)
            greed = False
